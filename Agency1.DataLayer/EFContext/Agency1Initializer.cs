    ...
    class Agency1Initializer :CreateDatabaseIfNotExists<Agency1Context>
    {
        protected override void Seed(Agency1Context context)
        {
            ...
            context.Applicants.AddRange(new Applicant[]
            {
                 ...
                 new Applicant { LastNameAp = "Любимова", NameAp = "Любовь", PatronymicAp = "Сергеевна", DateBirth = new DateTime(1976,01,02), Gender = Gender.женщина, PositionId = 2, Education = Education.высшее, ForeignLanguage = ForeignLanguage.английский, EstimatedSalary = 500, DateFilling = new DateTime(2018,5,4), AgentId = 3, OtherInformation = "Репитирор английского языка" },
                 new Applicant { LastNameAp = "Китова", NameAp = "Анастасия", PatronymicAp = "Александровна", DateBirth = new DateTime(1980,11,22), Gender = Gender.женщина, PositionId = 2, Education = Education.высшее,ForeignLanguage = ForeignLanguage.английский, EstimatedSalary = 600, DateFilling = new DateTime(2018,2,24), AgentId = 2, OtherInformation = "Репитирор английского языка" },
                 new Applicant { LastNameAp = "Тараскина", NameAp = "Надежда", PatronymicAp = "Сергеевна", DateBirth = new DateTime(1976,01,02), Gender = Gender.женщина, PositionId = 2, Education = Education.высшее,ForeignLanguage = ForeignLanguage.английский, EstimatedSalary = 500, DateFilling = new DateTime(2018,5,4), AgentId = 3, OtherInformation = "Репитирор немецкого,английского,французкого языка" },
            ...
            context.Vacancies.AddRange(new Vacancie[]
           {
                ...
                new Vacancie { EmployerId = 4, Gender = Gender.женщина, PositionId = 4, Education = Education.высшее, DrivingLicence = "нет", ForeignLanguage = ForeignLanguage.английский, Salary = 500, DateOpen = new DateTime(2018,03,05), OpenVacancy = OpenVacancy.да  },
                ...
                new Vacancie { EmployerId = 5, Gender = Gender.женщина, PositionId = 6, Education = Education.высшее, DrivingLicence = "нет", ForeignLanguage = ForeignLanguage.английский, Salary = 600, DateOpen = new DateTime(2018, 01, 05), OpenVacancy = OpenVacancy.нет},

                new Vacancie { EmployerId = 6, Gender = Gender.любой, PositionId = 7, Education = Education.высшее, ForeignLanguage = ForeignLanguage.английский, Salary = 800, DateOpen = new DateTime(2018,07,25), OpenVacancy = OpenVacancy.да  },
                new Vacancie { EmployerId = 7, Gender = Gender.мужчина, PositionId = 7, Education = Education.высшее, ForeignLanguage = ForeignLanguage.английский, Salary = 700, DateOpen = new DateTime(2018,06,18), OpenVacancy = OpenVacancy.да  },
